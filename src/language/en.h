...
#define bootscreen_01 "##########################################################################################################"
#define bootscreen_02 "#                                                                                                        #"
#define bootscreen_03 "#  ##   ##  ######  ####   ##  ##   ####   #####   ##  ##  ######  ##  ##   ####       ##   ## ##    ##  #"
#define bootscreen_04 "#  ### ###  ##     ##  ##  ##  ##  ##  ##  ##  ##  ##  ##    ##    ### ##  ##  ##      ### ### ##    ##  #"
#define bootscreen_05 "#  ## # ##  ####   ##      ######  ######  ##  ##  ##  ##    ##    ## ###  ##  ##      ## # ## ######### #"
#define bootscreen_06 "#  ##   ##  ##     ##  ##  ##  ##  ##  ##  ##  ##  ##  ##    ##    ##  ##  ##  ##      ##   ##       ##  #"
#define bootscreen_07 "#  ##   ##  ######  ####   ##  ##  ##  ##  #####    ####   ######  ##  ##   ####       ##   ##       ##  #"
#define bootscreen_08 "#                                                                                                        #"
#define bootscreen_09 "##########################################################################################################"
#define bootscreen_10 " open-source industrial servo motor by Tropical Labs                               written by Kai Wolter "
#define bootscreen_11 " compiling date: " __DATE__
#define bootscreen_12 " firmware-version: " firmware_version
